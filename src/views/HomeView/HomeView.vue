<template class="mouseHover">
  <div class="home">
    ...
    <div class="copyright">
      ...
      <span
        ><a style="color: #fff; font-size: 19px">滇ICP备2022000365号</a></span
      >
    </div>
  </div>
</template>
...
.home {
  position: relative;
  background: url("https://chaichaiimage.oss-cn-hangzhou.aliyuncs.com/blogimg/0d0c8d8cf7a915f399bb7d4d4ae06856.jpeg")
    no-repeat;
